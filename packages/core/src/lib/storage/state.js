...
import { writable2, intl, intlRange } from '@event-calendar/common/internal';
...
export default class {
	constructor(plugins, input) {
		...
		let commonOpts = Object.assign({}, options, input);
		parseOpts(commonOpts, this);
		let views = new Set([...Object.keys(options.views), ...Object.keys(input.views || {})]);
		for (let view of views) {
			let viewOpts = Object.assign(
				{},
				options.views[view] || {},
				(input.views && input.views[view]) || {}
			);
			parseOpts(viewOpts, this);
			let opts = Object.assign({}, commonOpts, viewOpts);
